...
class PromptSession(Generic[_T]):
    ...
    def __init__(
        ...
        *,
        ...
        cursor_shape_config: AnyCursorShapeConfig = None,
        ...
        self.cursor_shape_config = cursor_shape_config
    ...
    def _create_application(
        ...
        application: Application[_T] = Application(
            ...
            cursor_shape_config=DynamicCursorShapeConfig(
                lambda: self.cursor_shape_config
            ),
    ...
    def prompt(
        ...
        *,
        ...
        style: Optional[BaseStyle] = None,
        color_depth: Optional[ColorDepth] = None,
        cursor_shape_config: Optional[AnyCursorShapeConfig] = None,
        ...
        if color_depth is not None:
            self.color_depth = color_depth
        if cursor_shape_config is not None:
            self.cursor_shape_config = cursor_shape_config
    ...
    async def prompt_async(
        ...
        *,
        ...
        style: Optional[BaseStyle] = None,
        color_depth: Optional[ColorDepth] = None,
        cursor_shape_config: Optional[CursorShapeConfig] = None,
        include_default_pygments_style: Optional[FilterOrBool] = None,
        style_transformation: Optional[StyleTransformation] = None,
        swap_light_and_dark_colors: Optional[FilterOrBool] = None,
        rprompt: Optional[AnyFormattedText] = None,
...
def prompt(
    ...
    *,
    ...
    return session.prompt(
        ...
        cursor_shape_config=cursor_shape_config,
